...
function show(){
    ...
    <h2><span style="font-weight:100;">Time in </span><?php echo $details->geoplugin_city; echo ",\t"; echo $details->geoplugin_region; echo ",\t"; echo $details->geoplugin_countryName;?></h2>
		<h1 id="demo"></h1>
		<h3><?php echo $va1;?></h3>
...
<div class="container text-center text-md-left">
    ...
    <hr>
	<p>Time.ind.in automatically displays the time in your time zone by using your IP address to detect your location.  Your IP address is <a href="#"><?php  echo $IPaddress; ?></a>. Your detected location is <a href="#"><?php echo $details->city; echo ",\t"; echo $details->region; echo ",\t"; echo $details->country;?></a></p>
	</div>
  <div class="container text-center text-md-left">
