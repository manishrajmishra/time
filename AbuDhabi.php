...
function show(){
  ...
  <header class="page-header header container-fluid">
    ...
    <h2><span style="font-weight:100;">Time in </span><?php echo $details->geoplugin_city; echo ",\t"; echo $details->geoplugin_countryName;?></h2>
    <h1 id="demo"></h1>
    <h3><?php echo $va1;?></h3>
